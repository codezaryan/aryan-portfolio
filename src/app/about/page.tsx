...
import { aboutData, skillCategories } from "@/lib/config"
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Full-stack software developer with expertise in modern web technologies and a passion for building scalable solutions.
          </p>
        </motion.div>

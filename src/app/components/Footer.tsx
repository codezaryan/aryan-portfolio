...
export default function Footer() {
  ...
  const socialLinks = [
    { href: "https://github.com/aryanpatel7987", icon: <Github className="w-5 h-5" />, label: "GitHub" },
    { href: "https://linkedin.com/in/aryanpatel7987", icon: <Linkedin className="w-5 h-5" />, label: "LinkedIn" },
